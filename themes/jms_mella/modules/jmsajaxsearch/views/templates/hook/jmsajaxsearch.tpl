...
<div class="btn-group menu-collapse compact-hidden jms_ajax_search" id="jms_ajax_search">
	...
	<div id="search-form" class="search-box">
		...
		<form method="get" action="{$link->getPageLink('search')|escape:'html':'UTF-8'}" class="searchbox">
			...
			<input autofocus="autofocus" type="text" id="ajax_search" name="search_query" placeholder="{l s='Search products here' d='Modules.JmsAjaxsearch'}" class="form-control ajax_search" />
		</form>
